        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid main-header">
                <a class="navbar-brand" href="{{ URL::to('/') }}"><img
                        src="{{ asset('frontend/images/logo/brain 1.png') }}" alt=""><span class="ms-3">Learn
                        & Earn</span></a>
                ...
                <div class="collapse navbar-collapse  justify-content-end" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        @if (Session::has('username'))
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item" href="{{ route('creategroupstudy') }}">Create
                                            Group</a></li>
                                    <li><a class="dropdown-item" href="{{ route('viewgroupstudy') }}">Find All
                                            Group</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item" href="{{ route('createtuition') }}">Find Tutor</a>
                                    </li>
                                    <li><a class="dropdown-item" href="{{ route('viewtuition') }}">Find Tutor's
                                            Post</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                        ...
                        @else
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="upload_images/{{ Session::get('image') }}" id="navbarDropdownMenuLink" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false"><img
                                    src=" upload_images/{{ Session::get('image') }} "
                                    alt="{{ Session::get('username') }}"></a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="{{ route('personalinformation') }}">Profile</a>
                                </li>
                                {{-- <li><a class="dropdown-item" href="{{ route('updateprofile') }}">Settings</a></li> --}}
                                <li><a class="dropdown-item" href="{{ route('userlogout') }}">Logout</a>
                                </li>
                            </ul>
                        </li>
                        @endif
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-4 mx-auto mb-4">
                        ...
                        <p>
                            <a href="#" class="text-reset" style="text-decoration: none">Latest Events</a>
                        </p>
                        <p>
                            <a href="#" class="text-reset" style="text-decoration: none">Terms & Conditions</a>
                        </p>
                        <p>
                            <a href="#" class="text-reset" style="text-decoration: none">Privacy Policy</a>
                        </p>
                        <p>
                            <a href="#about" class="text-reset" style="text-decoration: none">About</a>
                        </p>
                    </div>
                    <!-- Grid column -->
