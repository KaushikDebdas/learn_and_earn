            ...
            <div class="row">
                ...
                <div class="col-md-7 mt-5 group-study" style="margin-left: 5%;">
                    ...
                    @foreach ($item_post as $row)
                        <div class="card mt-5">
                            <div class="card-body">
                                <h2 class="card-title" style="text-align:center;"><span>TUTOR NEEDED</span></h2>
                                <hr><br>
                    ...
                    @foreach ($item as $row)
                        <div class="card mt-5">
                            <div class="card-body">
                                ...
                                <p> Interested Members: <span
                                        class="data-highlighted">{{ $row->InterestedStudents }}</span></p>
